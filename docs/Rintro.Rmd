...
You will navigate to [https://rstudio.cloud](https://rstudio.cloud) and use your Pomona credentials to log in. If you are a Pomona student, this is simply your Pomona email. If you are a non-Pomona student, ITS should have provided you a Pomona account. You may need to first activate this account. to be able to proceed.
